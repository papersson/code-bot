...
export default function ChatsLayout({ children }: { children: React.ReactNode }) {
  ...
  // Add delete chat function near the other chat management functions
  ...
  // Add delete project function near the other project management functions
                            ...
                            >
                              {renamingChatId === chat.id ? (
                                ...
                                <div className="flex justify-between items-center w-full">
                                  <Link href={`/chats/${chat.id}`} className="text-sm">
